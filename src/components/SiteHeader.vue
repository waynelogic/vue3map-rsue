...
<!--                                <a href="#" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" aria-current="page">Dashboard</a>-->
                                <RouterLink v-for="page in pages" :key="page.name" :to="page.link"  class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                                    {{ page.name }}
                                </RouterLink>
